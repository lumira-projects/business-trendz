---
title: "Matrice McKinsey : Le guide complet pour l'analyse stratégique de portefeuille"
title_tag: "Matrice McKinsey : guide complet et utilisation pratique | Business Trendz"
description: "Découvrez la matrice McKinsey (GE-McKinsey) : définition, fonctionnement, guide en 5 étapes, comparaison BCG, étude de cas et template téléchargeable."
meta_description: "Découvrez la matrice McKinsey (GE-McKinsey) : définition, fonctionnement, guide en 5 étapes, comparaison BCG, étude de cas et template téléchargeable."
slug: "matrice-mckinsey"
pubDate: "2026-05-23T00:00:00.000Z"
updatedDate: "2026-05-23T00:00:00.000Z"
categories:
  - "Stratégie"
  - "Business"
heroImage: "/uploads/2026/05/matrice-mckinsey.webp"
heroImageAlt: "Consultant analysant un portefeuille d'activités avec la matrice McKinsey sur tableau blanc"
...
1. **Identifier les Domaines d'Activité Stratégique (DAS)**
2. **Choisir et pondérer les facteurs d'attrait du marché**
3. **Choisir et pondérer les facteurs de force compétitive**
4. **Noter et positionner chaque DAS sur la matrice**
5. **Formuler les implications stratégiques et le plan d'action**
...
1. Taille du marché (volume et valeur)
2. Taux de croissance annuel moyen (TCAM)
3. Marge bénéficiaire moyenne du secteur
4. Intensité concurrentielle (indice de concentration, nombre de concurrents)
5. Barrières à l'entrée (capitalistiques, réglementaires, technologiques)
6. Cyclicité et saisonnalité de la demande
7. Exposition aux risques macro-économiques (change, inflation, taux d'intérêt)
8. Attractivité pour les investisseurs et disponibilité des capitaux
...
2. Notoriété de marque et capital de marque
3. Avantage concurrentiel technologique ou brevet
4. Efficacité des coûts et structure de marge versus concurrents
5. Qualité et étendue du réseau de distribution
6. Capacité de production et flexibilité
7. Qualité et fidélisation de la base clients (NPS, taux de rétention)
8. Solidité financière et capacité d'investissement
...
**Prêt à analyser votre portefeuille ?** Téléchargez notre template Google Sheets gratuit pour construire votre propre matrice McKinsey. Il intègre les tableaux de pondération et de notation pour les deux axes, ainsi que la visualisation automatique de la grille 3×3 avec positionnement des DAS.
