---
title: "Doit-on signer une lettre de motivation : règles et bonnes pratiques"
description: "Faut-il signer une lettre de motivation ? Signature manuscrite ou électronique, candidature papier ou email : les règles selon le contexte."
...
categories:
  - "Entreprise"
  - "Business"
heroImage: "/uploads/2026/06/signer-lettre-de-motivation.webp"
heroImageAlt: "Doit-on signer une lettre de motivation : règles et bonnes pratiques"
readingTime: 5
---
...
<figure style="border:1px solid rgba(10,10,10,0.06);border-radius:16px;overflow:hidden;margin:2rem 0">
  ...
  <div style="padding:1.5rem 1.75rem;background:#FAFAFA">
    <div style="font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#9A9A9A;font-weight:600;margin-bottom:1.25rem">Méthodes de signature numérique</div>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1rem">
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">Scan</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.25rem">Signature manuscrite numérisée</div>
        <div style="font-size:13px;color:#0A0A0A;margin-top:0.5rem">Signer sur papier blanc, scanner en 300 dpi, insérer comme image dans Word ou Google Docs avant export PDF</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">Adobe</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.25rem">Acrobat Reader (gratuit)</div>
        <div style="font-size:13px;color:#0A0A0A;margin-top:0.5rem">Ouvrir le PDF, aller dans "Remplir et signer", tracer ou importer sa signature. Fonctionnel sans abonnement.</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">Docusign</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.25rem">Solution certifiée eIDAS</div>
        <div style="font-size:13px;color:#0A0A0A;margin-top:0.5rem">Version gratuite limitée à 3 documents par mois. Signature électronique simple ou avancée selon l'offre.</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">Mobile</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.25rem">Smartphone (iOS / Android)</div>
        <div style="font-size:13px;color:#0A0A0A;margin-top:0.5rem">Adobe Fill & Sign ou Smallpdf permettent de signer un PDF directement depuis l'écran tactile du téléphone.</div>
      </div>
    </div>
  </div>
</figure>
...
<figure style="border:1px solid rgba(10,10,10,0.06);border-radius:16px;overflow:hidden;margin:2rem 0">
  <div style="height:5px;background:linear-gradient(135deg,#1E3A8A 0%,#6366F1 35%,#EC4899 70%,#FF6B6B 100%)"></div>
  <div style="padding:1.5rem 1.75rem;background:#FAFAFA">
    <div style="font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#9A9A9A;font-weight:600;margin-bottom:1.25rem">Signature selon le canal de candidature</div>
    <div style="overflow-x:auto">
      <table style="width:100%;border-collapse:collapse;font-size:14px">
        <thead>
          <tr style="background:linear-gradient(135deg,rgba(30,58,138,0.07),rgba(255,107,107,0.07))">
            <th style="padding:0.75rem 1rem;text-align:left;font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;border-bottom:1px solid rgba(10,10,10,0.08)">Canal</th>
            <th style="padding:0.75rem 1rem;text-align:left;font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;border-bottom:1px solid rgba(10,10,10,0.08)">Signature requise</th>
            <th style="padding:0.75rem 1rem;text-align:left;font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;border-bottom:1px solid rgba(10,10,10,0.08)">Type recommandé</th>
            <th style="padding:0.75rem 1rem;text-align:left;font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;border-bottom:1px solid rgba(10,10,10,0.08)">Position</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom:1px solid rgba(10,10,10,0.05)">
            <td style="padding:0.75rem 1rem;color:#0A0A0A;font-weight:500">Courrier postal</td>
            <td style="padding:0.75rem 1rem;color:#16A34A">Oui (usage)</td>
            <td style="padding:0.75rem 1rem;color:#0A0A0A">Manuscrite</td>
            <td style="padding:0.75rem 1rem;color:#6B7280">Bas droite, après politesse</td>
          </tr>
          <tr style="border-bottom:1px solid rgba(10,10,10,0.05);background:rgba(10,10,10,0.015)">
            <td style="padding:0.75rem 1rem;color:#0A0A0A;font-weight:500">Email avec PDF joint</td>
            <td style="padding:0.75rem 1rem;color:#DC2626">Non recommandé</td>
            <td style="padding:0.75rem 1rem;color:#0A0A0A">Formule de politesse uniquement</td>
            <td style="padding:0.75rem 1rem;color:#6B7280">Fin de lettre</td>
          </tr>
          <tr style="border-bottom:1px solid rgba(10,10,10,0.05)">
            <td style="padding:0.75rem 1rem;color:#0A0A0A;font-weight:500">Corps de l'email</td>
            <td style="padding:0.75rem 1rem;color:#DC2626">Non</td>
            <td style="padding:0.75rem 1rem;color:#0A0A0A">Signature email auto</td>
            <td style="padding:0.75rem 1rem;color:#6B7280">Pied de l'email</td>
          </tr>
          <tr style="border-bottom:1px solid rgba(10,10,10,0.05);background:rgba(10,10,10,0.015)">
            <td style="padding:0.75rem 1rem;color:#0A0A0A;font-weight:500">Portail ATS / formulaire</td>
            <td style="padding:0.75rem 1rem;color:#DC2626">Non applicable</td>
            <td style="padding:0.75rem 1rem;color:#0A0A0A">Sans objet</td>
            <td style="padding:0.75rem 1rem;color:#6B7280">Sans objet</td>
          </tr>
          <tr>
            <td style="padding:0.75rem 1rem;color:#0A0A0A;font-weight:500">LinkedIn Easy Apply</td>
            <td style="padding:0.75rem 1rem;color:#DC2626">Non</td>
            <td style="padding:0.75rem 1rem;color:#0A0A0A">Sans objet</td>
            <td style="padding:0.75rem 1rem;color:#6B7280">Sans objet</td>
          </tr>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Est-il obligatoire de signer une lettre de motivation ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Non. Il n'existe aucune obligation légale ni réglementaire d'apposer une signature sur une lettre de motivation en France. C'est une convention de présentation : recommandée sur courrier papier, inutile sur email ou formulaire en ligne."
      }
    },
    {
      "@type": "Question",
      "name": "Où placer la signature sur une lettre de motivation papier ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "La signature se place en bas à droite de la dernière page, après la formule de politesse et avant ou en dessous du nom et prénom tapés. Laissez 3 à 4 lignes d'espace entre la formule de politesse et la signature manuscrite."
      }
    },
    {
      "@type": "Question",
      "name": "Comment signer une lettre de motivation envoyée en PDF ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pour une lettre PDF, deux options pratiques : insérer une image de votre signature manuscrite scannée dans Word ou Google Docs avant export PDF, ou utiliser Adobe Acrobat Reader via la fonction « Remplir et signer ». Dans la majorité des cas, pour un envoi par email, il est préférable de ne pas signer et de clore avec une formule de politesse."
      }
    },
    {
      "@type": "Question",
      "name": "Faut-il dater la lettre de motivation ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "L'usage veut que la date figure en haut à droite de la lettre. Pour les lettres papier, cette pratique est fortement recommandée. Pour les PDF envoyés par email, la date est moins importante : la date d'envoi de l'email fait foi."
      }
    },
    {
      "@type": "Question",
      "name": "Peut-on utiliser DocuSign pour signer une lettre de motivation ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Techniquement oui, mais ce n'est pas recommandé. DocuSign est prévu pour des actes engageants nécessitant une signature électronique certifiée. Pour une lettre de motivation, c'est surdimensionné. Préférez une signature scannée insérée comme image ou Adobe Acrobat Reader."
      }
    },
    {
      "@type": "Question",
      "name": "Une lettre de motivation sans signature sera-t-elle éliminée ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Non. Un recruteur n'élimine pas une candidature parce que la lettre de motivation ne porte pas de signature, notamment sur une candidature numérique. La qualité du contenu, l'adéquation au poste et la clarté de l'expression priment sur la présence ou l'absence d'une signature."
      }
    },
    {
      "@type": "Question",
      "name": "Doit-on signer la lettre de motivation et le CV ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Il est d'usage de signer la lettre de motivation sur papier, mais pas le CV. Le curriculum vitae est un document de présentation factuelle : il n'y a ni formule de politesse ni signature à y apposer."
      }
    }
  ]
}
