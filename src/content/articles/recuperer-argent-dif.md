---
title: "Comment récupérer l'argent du DIF"
description: "Le DIF a été remplacé par le CPF en 2015. Découvrez comment les heures DIF ont été converties en euros sur le CPF et comment utiliser vos droits formation aujourd'hui."
...
categories:
  - "Formation"
  - "Entreprise"
heroImage: "/uploads/2026/06/recuperer-argent-dif.webp"
heroImageAlt: "Comment récupérer l'argent du DIF"
readingTime: 6
---
...
<figure style="border:1px solid rgba(10,10,10,0.06);border-radius:16px;overflow:hidden;margin:2rem 0">
  <div style="height:5px;background:linear-gradient(135deg,#1E3A8A 0%,#6366F1 35%,#EC4899 70%,#FF6B6B 100%)"></div>
  <div style="padding:1.5rem 1.75rem;background:#FAFAFA">
    <div style="font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#9A9A9A;font-weight:600;margin-bottom:1.25rem">Règles de conversion DIF vers CPF</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem">
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1.25rem;text-align:center">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">15 €</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.4rem">par heure DIF</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1.25rem;text-align:center">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">1 500 €</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.4rem">plafond de transfert</div>
      </div>
      <div style="background:linear-gradient(135deg,rgba(30,58,138,0.05),rgba(255,107,107,0.05));border:1px solid rgba(30,58,138,0.15);border-radius:12px;padding:1.25rem;text-align:center">
        <div style="font-family:'Archivo Black',sans-serif;font-size:22px;background:linear-gradient(135deg,#1E3A8A,#FF6B6B);-webkit-background-clip:text;background-clip:text;color:transparent">30/06/21</div>
        <div style="font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:#9A9A9A;margin-top:0.4rem">date limite de transfert</div>
      </div>
    </div>
    <div style="margin-top:1rem;font-size:11px;color:#9A9A9A;text-align:center">Exemple : 80 heures DIF = 1 200 € crédités sur le CPF · 100 heures ou plus = 1 500 € (plafond)</div>
  </div>
</figure>

### La date limite qui change tout : le 30 juin 2021

Pour transférer ses heures DIF en euros sur son CPF, chaque bénéficiaire devait se connecter à la plateforme [moncompteformation.gouv.fr](https://www.moncompteformation.gouv.fr) et renseigner manuellement le nombre d'heures DIF acquises au 31 décembre 2014. Cette démarche devait être effectuée avant le **30 juin 2021**.
...
1. Rendez-vous sur [moncompteformation.gouv.fr](https://www.moncompteformation.gouv.fr)
2. Cliquez sur "Se connecter" en haut à droite
3. Authentifiez-vous via France Connect (en utilisant votre compte Ameli, impots.gouv.fr, ou la MSA selon votre situation)
4. Votre tableau de bord affiche votre solde en euros disponibles
5. Consultez l'historique des crédits pour identifier l'origine des fonds (alimentation annuelle, abondements, anciens droits DIF si transférés)
...
1. Identifiez la formation souhaitée et vérifiez son éligibilité sur moncompteformation.gouv.fr
2. Comparez les offres de plusieurs organismes de formation proposant la même certification
3. Vérifiez le financement : si le coût dépasse votre solde CPF, vous pouvez solliciter un abondement auprès de votre employeur, de votre OPCO (Opérateur de Compétences) ou de Pôle emploi (France Travail)
4. Effectuez votre inscription directement via la plateforme, sans passer par l'employeur pour les formations suivies hors temps de travail
5. Pour une formation pendant le temps de travail, l'accord de l'employeur reste requis
...
<figure style="border:1px solid rgba(10,10,10,0.06);border-radius:16px;overflow:hidden;margin:2rem 0">
  <div style="height:5px;background:linear-gradient(135deg,#1E3A8A 0%,#6366F1 35%,#EC4899 70%,#FF6B6B 100%)"></div>
  <div style="padding:1.5rem 1.75rem;background:#FAFAFA">
    <div style="font-size:11px;letter-spacing:0.16em;text-transform:uppercase;color:#9A9A9A;font-weight:600;margin-bottom:1.25rem">Dispositifs de financement de la formation en dehors du CPF</div>
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1rem">
      <div style="background:#fff;border:1px solid rgba(10,10,10,0.06);border-radius:12px;padding:1.25rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:13px;color:#0A0A0A;margin-bottom:0.5rem">Plan de développement des compétences</div>
        <div style="font-size:11px;color:#9A9A9A;line-height:1.5">Financé par l'employeur, pour des formations décidées par l'entreprise ou à l'initiative du salarié avec accord. Aucun reste à charge pour le salarié.</div>
      </div>
      <div style="background:#fff;border:1px solid rgba(10,10,10,0.06);border-radius:12px;padding:1.25rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:13px;color:#0A0A0A;margin-bottom:0.5rem">Pro-A (reconversion ou promotion)</div>
        <div style="font-size:11px;color:#9A9A9A;line-height:1.5">Alternance pour les salariés en CDI ou CDD souhaitant se reconvertir ou évoluer. Financé par l'OPCO de la branche.</div>
      </div>
      <div style="background:#fff;border:1px solid rgba(10,10,10,0.06);border-radius:12px;padding:1.25rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:13px;color:#0A0A0A;margin-bottom:0.5rem">Projet de Transition Professionnelle (PTP)</div>
        <div style="font-size:11px;color:#9A9A9A;line-height:1.5">Successeur du CIF. Permet de se former à un nouveau métier tout en maintenant sa rémunération. Géré par les Transitions Pro régionales.</div>
      </div>
      <div style="background:#fff;border:1px solid rgba(10,10,10,0.06);border-radius:12px;padding:1.25rem">
        <div style="font-family:'Archivo Black',sans-serif;font-size:13px;color:#0A0A0A;margin-bottom:0.5rem">Abondements CPF</div>
        <div style="font-size:11px;color:#9A9A9A;line-height:1.5">Des financeurs tiers (employeur, OPCO, Région, France Travail) peuvent compléter le solde CPF si celui-ci est insuffisant pour couvrir le coût de la formation.</div>
      </div>
    </div>
  </div>
</figure>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Mes heures DIF sont-elles encore récupérables après le 30 juin 2021 ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Non. Le 30 juin 2021 constitue la date limite définitive pour le transfert des heures DIF vers le CPF. Passée cette date, la plateforme moncompteformation.gouv.fr n'accepte plus aucune saisie d'heures DIF. Les droits non transférés sont perdus sans possibilité de recours."
      }
    },
    {
      "@type": "Question",
      "name": "Comment savoir combien d'heures DIF j'avais accumulé ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Le nombre d'heures DIF au 31 décembre 2014 figurait sur les bulletins de salaire de janvier 2015. Certains employeurs l'indiquaient également dans un document récapitulatif. Si vous ne retrouvez pas ce document, votre ancien employeur peut en théorie vous fournir cette information."
      }
    },
    {
      "@type": "Question",
      "name": "Combien d'euros aurais-je eu sur mon CPF si j'avais transféré mes heures DIF ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Le calcul est : nombre d'heures DIF multiplié par 15 euros, dans la limite de 1 500 euros. Par exemple, 60 heures auraient représenté 900 euros, et 100 heures ou plus auraient donné le maximum de 1 500 euros."
      }
    },
    {
      "@type": "Question",
      "name": "Le CPF fonctionne-t-il pour les agents de la fonction publique ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui, mais avec des modalités spécifiques selon les versants (fonction publique d'État, territoriale, hospitalière). Les règles d'alimentation et d'utilisation diffèrent du secteur privé. Il convient de se renseigner auprès de son service RH ou de la DGAFP."
      }
    },
    {
      "@type": "Question",
      "name": "Peut-on cumuler CPF et autres financements pour une formation coûteuse ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui. Le CPF est cumulable avec d'autres sources de financement : abondement de l'employeur, financement par l'OPCO, aide de France Travail pour les demandeurs d'emploi, ou financement régional. Si le coût de la formation dépasse le solde CPF, ces abondements peuvent être sollicités avant inscription."
      }
    },
    {
      "@type": "Question",
      "name": "Le reste à charge de 100 euros s'applique-t-il dans tous les cas ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Non. Ce reste à charge ne s'applique pas aux demandeurs d'emploi, aux bénéficiaires de minima sociaux, aux formations prescrites par France Travail, ni lorsque l'employeur abonde le CPF. Pour les salariés du secteur privé finançant seuls leur formation, ce montant est obligatoire."
      }
    },
    {
      "@type": "Question",
      "name": "Le solde CPF se perd-il si on change d'employeur ou si on devient indépendant ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Non. Le compte est attaché à la personne, pas au contrat de travail. Le solde est conservé intégralement lors d'un changement d'employeur, d'une période de chômage, d'une reconversion en travailleur indépendant, ou jusqu'au départ effectif à la retraite."
      }
    }
  ]
}
